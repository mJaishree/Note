...
import { Note } from '@/firebase/notes'
      ...
      <div className="bg-[#92C5CB] px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={loading}
            className="px-4 py-2 bg-[#D4B5A0] text-gray-800 rounded-lg font-semibold hover:bg-[#C9A892] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Edit
          </button>
          <button
